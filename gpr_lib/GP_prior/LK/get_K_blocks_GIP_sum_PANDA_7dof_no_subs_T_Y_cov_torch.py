...
def get_K_blocks_GIP_sum_PANDA_7dof_no_subs(X1, X2, pos_indices, vel_indices, acc_indices, sigma_kin_vel_list, sigma_kin_pos_list, sigma_pot_list):
    ...
    x60 = dq_i5*dq_j5
    x61 = sigma_kin_v_5_1*x12 + sigma_kin_v_5_2*x13 + sigma_kin_v_5_3*x26 + sigma_kin_v_5_4*x42 + sigma_kin_v_5_5*x60
    x62 = x61**2
    ...
    x108 = ddq_j7*x107
    x109 = dq_i6*dq_j6
    x110 = sigma_kin_v_6_1*x12 + sigma_kin_v_6_2*x13 + sigma_kin_v_6_3*x26 + sigma_kin_v_6_4*x42 + sigma_kin_v_6_5*x60 + sigma_kin_v_6_6*x109
    x111 = x110**2
    ...
    x125 = dq_j7*x107
    x126 = sigma_kin_v_7_1*x12 + sigma_kin_v_7_2*x13 + sigma_kin_v_7_3*x26 + sigma_kin_v_7_4*x42 + sigma_kin_v_7_5*x60 + sigma_kin_v_7_6*x109 + x125
    x127 = x126**2
    x128 = x127*x80
    ...
    x174 = dq_i1*(sigma_kin_v_3_3*x173 + sigma_kin_v_4_3*x155 + sigma_kin_v_5_3*x150 + sigma_kin_v_6_3*x139 + sigma_kin_v_7_3*x106)
    x175 = ddq_j2*dq_i2
    x176 = x24**2
    x177 = x176*x23
    x178 = dq_i1*(sigma_kin_v_2_1*sigma_kin_v_2_2*x177 + sigma_kin_v_3_2*x173 + sigma_kin_v_4_2*x155 + sigma_kin_v_5_2*x150 + sigma_kin_v_6_2*x139 + sigma_kin_v_7_2*x106)
    x179 = x50*x54
    x180 = x51*x53
    ...
    x233 = x164*x226
    x234 = x168*x223
    x235 = sigma_kin_v_3_2*sigma_kin_v_3_3*x172 + sigma_kin_v_4_3*x229 + sigma_kin_v_5_3*x227 + sigma_kin_v_6_3*x224 + sigma_kin_v_7_3*x219
    ...
    x252 = sigma_kin_v_4_3*sigma_kin_v_4_4*x154 + sigma_kin_v_5_4*x250 + sigma_kin_v_6_4*x247 + sigma_kin_v_7_4*x244
    ...
    K_block_list = []
    K_block_list.append(2*ddq_j1*x0*(sigma_kin_v_2_1**2*x177 + sigma_kin_v_3_1**2*x172 + sigma_kin_v_4_1**2*x154 + sigma_kin_v_5_1**2*x149 + sigma_kin_v_6_1**2*x138 + sigma_kin_v_7_1**2*x105 + x1*x10**2) + 2*dq_i1*x106*x108 + 2*dq_j1**2*x0*x11 - 2*dq_j2*x131*(x191*x209 + x194*x210 + x197*x211 + x200*x212 + x204*x214 + x207*x208) - 2*dq_j3*x131*(x189*x191 + x192*x194 + x195*x197 + x198*x200 + x202*x204) - 2*dq_j4*x131*(x162*x183 + x165*x184 + x169*x186 + x181*x182) - 2*dq_j5*x131*(x159*x162 + x163*x165 + x167*x169) - 2*dq_j6*x131*(x132*x146 + x143*x144) + 2*x111*x124 - 4*x12*(x11*x12 + x124*x144 + x132*x215 + x161*x79 + x182*x59 + x190*x41 + x208*x25) + 2*x128*x130 - 2*x131*x132*x135 + 2*x136*x140 + 2*x147*x151 + 2*x15*x25 + 2*x152*x156 + 2*x170*x174 + 2*x175*x178 + 2*x28*x41 + 2*x44*x59 + 2*x62*x79)
    K_block_list.append(2*ddq_j1*dq_i2*x178 + 2*ddq_j2*dq_i2**2*(sigma_kin_v_2_2**2*x177 + sigma_kin_v_3_2**2*x172 + sigma_kin_v_4_2**2*x154 + sigma_kin_v_5_2**2*x149 + sigma_kin_v_6_2**2*x138 + sigma_kin_v_7_2**2*x105) + 2*dq_i2*x108*x219 + 2*dq_i2*x136*x225 + 2*dq_i2*x147*x228 + 2*dq_i2*x152*x230 + 2*dq_i2*x170*x235 - 2*dq_j1*x222*(x124*x226 + x215*x223 + x231*x79 + x236*x59 + x237*x41 + x243*x25) - 2*dq_j3*x222*(x189*x238 + x192*x239 + x195*x240 + x198*x241 + x202*x242) - 2*dq_j4*x222*(x181*x236 + x183*x232 + x184*x233 + x186*x234) - 2*dq_j5*x222*(x159*x232 + x163*x233 + x167*x234) - 2*dq_j6*x222*(x143*x226 + x146*x223) - 4*x13*(x207*x243 + x209*x238 + x210*x239 + x211*x240 + x212*x241 + x214*x242) - 2*x135*x222*x223 + 2*x15*x207 + 2*x209*x216 + 2*x210*x217 + 2*x211*x218 + 2*x212*x220 + 2*x214*x221)
    K_block_list.append(2*ddq_j1*dq_i3*x174 + 2*ddq_j3*dq_i3**2*(sigma_kin_v_3_3**2*x172 + sigma_kin_v_4_3**2*x154 + sigma_kin_v_5_3**2*x149 + sigma_kin_v_6_3**2*x138 + sigma_kin_v_7_3**2*x105) + 2*dq_i3*x108*x244 + 2*dq_i3*x136*x248 + 2*dq_i3*x147*x251 + 2*dq_i3*x152*x252 + 2*dq_i3*x175*x235 - 2*dq_j1*x245*(x124*x249 + x215*x246 + x253*x79 + x257*x59 + x258*x41) - 2*dq_j2*x245*(x209*x259 + x210*x260 + x211*x261 + x212*x262 + x214*x263) - 2*dq_j4*x245*(x181*x257 + x183*x254 + x184*x255 + x186*x256) - 2*dq_j5*x245*(x159*x254 + x163*x255 + x167*x256) - 2*dq_j6*x245*(x143*x249 + x146*x246) - 2*x135*x245*x246 + 2*x189*x216 + 2*x192*x217 + 2*x195*x218 + 2*x198*x220 + 2*x202*x221 - 4*x26*(x189*x259 + x192*x260 + x195*x261 + x198*x262 + x202*x263))
    K_block_list.append(2*ddq_j1*dq_i4*x156 + 2*ddq_j4*dq_i4**2*(sigma_kin_v_4_4**2*x154 + sigma_kin_v_5_4**2*x149 + sigma_kin_v_6_4**2*x138 + sigma_kin_v_7_4**2*x105) + 2*dq_i4*x108*x265 + 2*dq_i4*x136*x271 + 2*dq_i4*x147*x273 + 2*dq_i4*x170*x252 + 2*dq_i4*x175*x230 - 2*dq_j1*x268*(x124*x272 + x215*x269 + x274*x79 + x278*x59) - 2*dq_j2*x268*(x210*x279 + x211*x280 + x212*x281 + x214*x282) - 2*dq_j3*x268*(x192*x279 + x195*x280 + x198*x281 + x202*x282) - 2*dq_j5*x268*(x159*x275 + x163*x276 + x167*x277) - 2*dq_j6*x268*(x143*x272 + x146*x269) - 2*x135*x268*x269 + 2*x181*x44 + 2*x183*x264 + 2*x184*x266 + 2*x186*x267 - 4*x42*(x181*x278 + x183*x275 + x184*x276 + x186*x277))
    K_block_list.append(2*ddq_j1*dq_i5*x151 + 2*ddq_j5*dq_i5**2*(sigma_kin_v_5_5**2*x149 + sigma_kin_v_6_5**2*x138 + sigma_kin_v_7_5**2*x105) + 2*dq_i5*x108*x283 + 2*dq_i5*x136*x286 + 2*dq_i5*x152*x273 + 2*dq_i5*x170*x251 + 2*dq_i5*x175*x228 - 2*dq_j1*x284*(x124*x287 + x215*x285 + x288*x79) - 2*dq_j2*x284*(x211*x289 + x212*x290 + x214*x291) - 2*dq_j3*x284*(x195*x289 + x198*x290 + x202*x291) - 2*dq_j4*x284*(x183*x292 + x184*x293 + x186*x294) - 2*dq_j6*x284*(x143*x287 + x146*x285) - 2*x135*x284*x285 + 2*x159*x264 + 2*x163*x266 + 2*x167*x267 - 4*x60*(x159*x292 + x163*x293 + x167*x294))
    K_block_list.append(2*ddq_j1*dq_i6*x140 + 2*ddq_j6*dq_i6**2*(sigma_kin_v_6_6**2*x138 + sigma_kin_v_7_6**2*x105) + 2*dq_i6*sigma_kin_v_7_6*x105*x108 + 2*dq_i6*x147*x286 + 2*dq_i6*x152*x271 + 2*dq_i6*x170*x248 + 2*dq_i6*x175*x225 - 2*dq_j1*x295*(x124*x297 + x215*x296) - 2*dq_j2*x295*(x212*x298 + x214*x299) - 2*dq_j3*x295*(x198*x298 + x202*x299) - 2*dq_j4*x295*(x184*x300 + x186*x301) - 2*dq_j5*x295*(x163*x300 + x167*x301) - 4*x109*(x143*x297 + x146*x296) + 2*x111*x143 + 2*x127*x146 - 2*x135*x295*x296)
    K_block_list.append(x303*x308*(ddq_j1*dq_i1*sigma_kin_v_7_1*x305 + ddq_j7*dq_i7**2*sigma_kin_v_7_7**2*x304 - 2*dq_j1*x129*x303*x307 - dq_j2*x213*x309*x84 - dq_j3*x201*x309*x82 - dq_j4*x185*x310*x88 - dq_j5*x166*x310*x86 - dq_j6*x102*x145*x307*x308*x82*x84*x86*x88 + sigma_kin_v_7_2*x175*x305 + sigma_kin_v_7_3*x170*x305 + sigma_kin_v_7_4*x152*x305 + sigma_kin_v_7_5*x147*x305 + sigma_kin_v_7_6*x136*x305 - x125*x126*x306*x308 + x128*x306))
