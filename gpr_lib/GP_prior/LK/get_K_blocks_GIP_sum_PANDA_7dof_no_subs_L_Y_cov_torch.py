...
def get_K_blocks_GIP_sum_PANDA_7dof_no_subs(X1, X2, pos_indices, vel_indices, acc_indices, sigma_kin_vel_list, sigma_kin_pos_list, sigma_pot_list):
    ...
    x104 = dq_i5*dq_j5
    x105 = sigma_kin_v_5_1*x22 + sigma_kin_v_5_2*x23 + sigma_kin_v_5_3*x41 + sigma_kin_v_5_4*x61 + sigma_kin_v_5_5*x104
    x106 = 2*x105**2
    ...
    x145 = dq_i6*dq_j6
    x146 = sigma_kin_v_6_1*x22 + sigma_kin_v_6_2*x23 + sigma_kin_v_6_3*x41 + sigma_kin_v_6_4*x61 + sigma_kin_v_6_5*x104 + sigma_kin_v_6_6*x145
    x147 = 2*x146**2
    x148 = x112*x126*(x110*x2 - x111*x5)
    x149 = dq_j7*x107
    x150 = sigma_kin_v_7_1*x22 + sigma_kin_v_7_2*x23 + sigma_kin_v_7_3*x41 + sigma_kin_v_7_4*x61 + sigma_kin_v_7_5*x104 + sigma_kin_v_7_6*x145 + x149
    x151 = 2*x150**2
    x152 = 4*dq_i1
    ...
    x199 = dq_i1*(sigma_kin_v_3_3*x198 + sigma_kin_v_4_3*x180 + sigma_kin_v_5_3*x174 + sigma_kin_v_6_3*x163 + sigma_kin_v_7_3*x128)
    x200 = 2*ddq_j2
    x201 = dq_i2*x200
    x202 = x20**2
    x203 = x17*x202
    x204 = dq_i1*(sigma_kin_v_2_1*sigma_kin_v_2_2*x203 + sigma_kin_v_3_2*x198 + sigma_kin_v_4_2*x180 + sigma_kin_v_5_2*x174 + sigma_kin_v_6_2*x163 + sigma_kin_v_7_2*x128)
    x205 = 2*ddq_j1
    ...
    x260 = x188*x252
    x261 = x191*x247
    x262 = sigma_kin_v_3_2*sigma_kin_v_3_3*x197 + sigma_kin_v_4_3*x256 + sigma_kin_v_5_3*x254 + sigma_kin_v_6_3*x250 + sigma_kin_v_7_3*x243
    ...
    x285 = sigma_kin_v_4_3*sigma_kin_v_4_4*x179 + sigma_kin_v_5_4*x283 + sigma_kin_v_6_4*x280 + sigma_kin_v_7_4*x275
    ...
    K_block_list = []
    K_block_list.append(2*dq_j1**2*x0*x9 - dq_j2*x152*(x214*x234 + x219*x235 + x222*x236 + x225*x237 + x228*x238 + x230*x233) - dq_j3*x152*(x214*x217 + x219*x220 + x222*x223 + x225*x226 + x228*x229) - dq_j4*x152*(x184*x210 + x189*x211 + x192*x212 + x206*x209) - dq_j5*x152*(x184*x187 + x189*x190 + x192*x193) - dq_j6*x152*(x155*x169 + x165*x168) - dq_j7*x152*x155*x158 + x0*x205*(sigma_kin_v_2_1**2*x203 + sigma_kin_v_3_1**2*x197 + sigma_kin_v_4_1**2*x179 + sigma_kin_v_5_1**2*x173 + sigma_kin_v_6_1**2*x162 + sigma_kin_v_7_1**2*x127 + x1*x8**2) + x103*x106 + x109*x129 + x144*x147 + x148*x151 + x160*x164 + x171*x175 + x177*x181 + x195*x199 + x201*x204 + x21*x25 - 4*x22*(x103*x182 + x144*x165 + x148*x153 + x206*x60 + x21*x230 + x213*x40 + x22*x9) + x40*x43 + x60*x63 + x66*x90*(x2*x64 - x5*x65))
    K_block_list.append(dq_i2**2*x200*(sigma_kin_v_2_2**2*x203 + sigma_kin_v_3_2**2*x197 + sigma_kin_v_4_2**2*x179 + sigma_kin_v_5_2**2*x173 + sigma_kin_v_6_2**2*x162 + sigma_kin_v_7_2**2*x127) + dq_i2*x109*x243 + dq_i2*x160*x251 + dq_i2*x171*x255 + dq_i2*x177*x257 + dq_i2*x195*x262 + dq_i2*x204*x205 - dq_j1*x246*(x103*x258 + x144*x252 + x148*x247 + x21*x270 + x263*x60 + x264*x40) - dq_j3*x246*(x217*x265 + x220*x266 + x223*x267 + x226*x268 + x229*x269) - dq_j4*x246*(x209*x263 + x210*x259 + x211*x260 + x212*x261) - dq_j5*x246*(x187*x259 + x190*x260 + x193*x261) - dq_j6*x246*(x168*x252 + x247*x253) + x106*x242 + x147*x244 + x151*x245 - 4*x23*(x233*x270 + x234*x265 + x235*x266 + x236*x267 + x237*x268 + x238*x269) + x233*x25 + x239*x43 + x240*x63 + x241*x90*(sigma_pot_2_c*x231 - sigma_pot_2_s*x232) - x246*x247*x249)
    K_block_list.append(dq_i3**2*x194*(sigma_kin_v_3_3**2*x197 + sigma_kin_v_4_3**2*x179 + sigma_kin_v_5_3**2*x173 + sigma_kin_v_6_3**2*x162 + sigma_kin_v_7_3**2*x127) + dq_i3*x109*x275 + dq_i3*x160*x281 + dq_i3*x171*x284 + dq_i3*x177*x285 + dq_i3*x199*x205 + dq_i3*x201*x262 - dq_j1*x278*(x103*x286 + x144*x282 + x148*x279 + x290*x60 + x291*x40) - dq_j2*x278*(x239*x291 + x240*x290 + x242*x286 + x244*x282 + x245*x279) - dq_j4*x278*(x209*x290 + x210*x287 + x211*x288 + x212*x289) - dq_j5*x278*(x187*x287 + x190*x288 + x193*x289) - dq_j6*x278*(x168*x282 + x253*x279) + x106*x274 + x147*x276 + x151*x277 - x249*x278*x279 + x271*x43 + x272*x63 + x273*x68*(sigma_pot_3_c*x215 - sigma_pot_3_s*x216) - 4*x41*(x271*x291 + x272*x290 + x274*x286 + x276*x282 + x277*x279))
    K_block_list.append(dq_i4**2*x176*(sigma_kin_v_4_4**2*x179 + sigma_kin_v_5_4**2*x173 + sigma_kin_v_6_4**2*x162 + sigma_kin_v_7_4**2*x127) + dq_i4*x109*x293 + dq_i4*x160*x299 + dq_i4*x171*x301 + dq_i4*x181*x205 + dq_i4*x195*x285 + dq_i4*x201*x257 - dq_j1*x296*(x103*x302 + x144*x300 + x148*x297 + x306*x60) - dq_j2*x296*(x240*x306 + x242*x302 + x244*x300 + x245*x297) - dq_j3*x296*(x272*x306 + x274*x302 + x276*x300 + x277*x297) - dq_j5*x296*(x187*x303 + x190*x304 + x193*x305) - dq_j6*x296*(x168*x300 + x253*x297) + x106*x292 + x147*x294 + x151*x295 + x209*x63 - x249*x296*x297 + x273*x67*(sigma_pot_4_c*x207 - sigma_pot_4_s*x208) - 4*x61*(x209*x306 + x210*x303 + x211*x304 + x212*x305))
    K_block_list.append(dq_i5**2*x170*(sigma_kin_v_5_5**2*x173 + sigma_kin_v_6_5**2*x162 + sigma_kin_v_7_5**2*x127) + dq_i5*x109*x309 + dq_i5*x160*x314 + dq_i5*x175*x205 + dq_i5*x177*x301 + dq_i5*x195*x284 + dq_i5*x201*x255 - dq_j1*x312*(x103*x316 + x144*x315 + x148*x313) - dq_j2*x312*(x242*x316 + x244*x315 + x245*x313) - dq_j3*x312*(x274*x316 + x276*x315 + x277*x313) - dq_j4*x312*(x292*x316 + x294*x315 + x295*x313) - dq_j6*x312*(x168*x315 + x253*x313) - 4*x104*(x308*x316 + x310*x315 + x311*x313) + x106*x308 + x147*x310 + x151*x311 - x249*x312*x313 + x307*x82*(sigma_pot_5_c*x185 - sigma_pot_5_s*x186))
    K_block_list.append(dq_i6**2*x159*(sigma_kin_v_6_6**2*x162 + sigma_kin_v_7_6**2*x127) + dq_i6*x164*x205 + dq_i6*x171*x314 + dq_i6*x177*x299 + dq_i6*x195*x281 + dq_i6*x201*x251 + dq_i6*x317*x318 - dq_j1*x319*(x144*x321 + x148*x320) - dq_j2*x319*(x244*x321 + x245*x320) - dq_j3*x319*(x276*x321 + x277*x320) - dq_j4*x319*(x294*x321 + x295*x320) - dq_j5*x319*(x310*x321 + x311*x320) - 4*x145*(x168*x321 + x253*x320) + x147*x168 + x151*x253 - x249*x319*x320 + x307*x75*(sigma_pot_6_c*x166 - sigma_pot_6_s*x167))
    K_block_list.append(dq_i7**2*sigma_kin_v_7_7**2*x317 - dq_j1*x148*x323 - dq_j2*x245*x323 - dq_j3*x277*x323 - dq_j4*x295*x323 - dq_j5*x311*x323 - dq_j6*x253*x323 + x107*x129*x205 + x107*x171*x309 + x107*x177*x293 + x107*x195*x275 + x107*x201*x243 + x127*x160*x318 - x149*x248*x322 + x151*x248 + 1.0*x241*x66*x67*x68*x75*x82*(sigma_pot_7_c*x156 - sigma_pot_7_s*x157))
