...
def get_K_blocks_RBF_1_sc_7dof_no_subs(X1, X2, pos_indices, vel_indices, acc_indices, lL, sL):
    ...
    x85 = dq_j7*x84
    x86 = 2*sL*torch.exp(-x1*x3**2 - x10**2*x8 - x11**2*x12 - x16**2*x17 - x20**2*x21 - x24**2*x25 - x28**2*x29 - x32**2*x33 - x38*x40**2 - x42*x43**2 - x47*x49**2 - x5*x6**2 - x50*x51**2 - x55*x57**2 - x58*x59**2 - x63*x65**2 - x66*x67**2 - x71*x73**2 - x74*x75**2 - x79*x81**2 - x82*x83**2)
    x87 = 2*x8
    x88 = x10*x87
    x89 = 2*x17
    x90 = x16*x89
    ...
    K_block_list = []
    K_block_list.append(x86*(-ddq_j1*x12*(-x11**2*x13 + 1) + x14*x19 + x14*x23 + x14*x27 + x14*x31 + x14*x35 + x14*x36 + x14*x45 - x14*x53 - x14*x61 - x14*x69 - x14*x77 - x14*x85 + x15*x9 + x4 - x7))
    K_block_list.append(x86*(ddq_j1*x15*x8 + x19*x88 + x23*x88 + x27*x88 + x31*x88 + x35*x88 + x36*x88 - x41 + x44 + x45*x88 - x53*x88 - x61*x88 - x69*x88 - x77*x88 - x85*x88 - x9*(-x10**2*x87 + 1)))
    K_block_list.append(x86*(-x18*(-x16**2*x89 + 1) + x23*x90 + x27*x90 + x31*x90 + x35*x90 + x36*x90 + x45*x90 + x52 - x53*x90 - x61*x90 - x69*x90 - x77*x90 - x85*x90 + x91*x92 + x91*x93))
    K_block_list.append(x86*(-x22*(-x20**2*x94 + 1) + x27*x95 + x31*x95 + x35*x95 + x36*x95 + x45*x95 - x53*x95 + x60 - x61*x95 - x69*x95 - x77*x95 - x85*x95 + x92*x96 + x93*x96 + x96*x97))
    K_block_list.append(x86*(x100*x101 + x100*x92 + x100*x93 + x100*x97 - x26*(-x24**2*x98 + 1) + x31*x99 + x35*x99 + x36*x99 + x45*x99 - x53*x99 - x61*x99 + x68 - x69*x99 - x77*x99 - x85*x99))
    K_block_list.append(x86*(x101*x104 + x103*x35 + x103*x36 + x103*x45 - x103*x53 - x103*x61 - x103*x69 - x103*x77 - x103*x85 + x104*x105 + x104*x92 + x104*x93 + x104*x97 - x30*(-x102*x28**2 + 1) + x76))
    K_block_list.append(x86*(ddq_j6*x103*x108 + x101*x108 + x105*x108 + x107*x36 + x107*x45 - x107*x53 - x107*x61 - x107*x69 - x107*x77 - x107*x85 + x108*x92 + x108*x93 + x108*x97 - x34*(-x106*x32**2 + 1) + x84))
